    ...
    <div class="container min-vh-100 d-flex align-items-center justify-content-center py-5">
        <div class="card shadow-sm" style="max-width: 480px; width: 100%;">
            <div class="card-body p-4 p-md-5">
                ...
                <h2 class="h5 fw-semibold mb-2">Masuk ke Akun</h2>
                <p class="text-muted mb-4">Masuk untuk mengakses koleksi buku dan fitur.</p>
                ...
                <p class="text-center text-muted mt-3 mb-0">
                    Belum punya akun?
                    <a href="{{ Route::has('register') ? route('register') : url('/register') }}" class="fw-semibold text-decoration-none">Daftar sekarang</a>
                </p>
